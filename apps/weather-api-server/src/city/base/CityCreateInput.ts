...
class CityCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ForecastCreateNestedManyWithoutCitiesInput,
  })
  @ValidateNested()
  @Type(() => ForecastCreateNestedManyWithoutCitiesInput)
  @IsOptional()
  @Field(() => ForecastCreateNestedManyWithoutCitiesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => WeatherReportCreateNestedManyWithoutCitiesInput,
  })
  @ValidateNested()
  @Type(() => WeatherReportCreateNestedManyWithoutCitiesInput)
  @IsOptional()
  @Field(() => WeatherReportCreateNestedManyWithoutCitiesInput, {
    nullable: true,
  })
